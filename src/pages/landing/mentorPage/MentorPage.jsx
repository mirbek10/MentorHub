...
// import { IoHeartSharp, IoMdHeart } from "react-icons/io5";
...
const MentorPage = () => {
  ...
  return (
    <div className="mentor-page">
      ...
      {/* main info */}
      <div className="mentor-page__top">
        ...
        {/* Mentor details */}
        <div className="mentor-page__details">
          <h1>Данные ментора</h1>
          <div className="mentor-page__tags">
            <div>Опыт {mentorInfo.workExperience}</div>
            <div>Работает в {mentorInfo.company}</div>
            <div>Специалист {mentorInfo.specialty}</div>
          </div>
          <h1>Место работы</h1>
        ...
        <div className="mentor-page__desc">
          <h1>Описание</h1>
          <p>
            Вы узнаете в этом курсе, как создавать сайты с нуля. Научитесь работать с программами как Figma, After Effects. Сделаем 3 проекта для портфолио.
          </p>
        </div>
      </div>

      {/* Projects */}
      <div className="mentor-page__projects">
